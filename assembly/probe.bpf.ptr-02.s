...
LBB1_8:                                 #   in Loop: Header=BB1_1 Depth=1
	...
	#DEBUG_VALUE: exec_prog:ctx <- $r7
	#DEBUG_VALUE: exec_one_repro:ip <- $r6
...
.Ltmp195:
	r0 += 4
.Ltmp196:
	.loc	1 96 16 is_stmt 1               # probe.bpf.c:96:16
.Ltmp197:
.Ltmp198:
	r2 = *(u8 *)(r0 + 1)
	.loc	1 97 24                         # probe.bpf.c:97:24
.Ltmp199:
	r0 = *(u64 *)(r7 + 16)
.Ltmp200:
.Ltmp201:
	#DEBUG_VALUE: exec_one_repro:immediate <- $r2
	.loc	1 97 27 is_stmt 0               # probe.bpf.c:97:27
.Ltmp202:
	r0 += r2
.Ltmp203:
.Ltmp204:
	#DEBUG_VALUE: stack_push:word <- $r0
...
.Linfo_string85:
	...
	.long	14
	.long	13
	.long	1577                            # BTF_KIND_VAR(id = 21)
	.long	234881024                       # 0xe000000
	.long	20
	.long	1
	.long	1585                            # BTF_KIND_VAR(id = 22)
	.long	234881024                       # 0xe000000
	.long	5
	.long	1
	.long	1592                            # BTF_KIND_STRUCT(id = 23)
	...
	.long	10
	.long	320                             # 0x140
	.long	1610                            # BTF_KIND_STRUCT(id = 24)
	.long	67108866                        # 0x4000002
	.long	40
	.long	1621
	.long	25
	...
	.long	10
	.long	128                             # 0x80
	.long	1642                            # BTF_KIND_STRUCT(id = 25)
	.long	67108867                        # 0x4000003
	.long	16
	.long	1656
	.long	5
	...
	.long	14
	.long	200
	.long	1676                            # BTF_KIND_VAR(id = 28)
	.long	234881024                       # 0xe000000
	.long	27
	.long	1
	.long	1686                            # BTF_KIND_DATASEC(id = 29)
	...
	.long	stack_buf
	.long	200
	.long	1691                            # BTF_KIND_DATASEC(id = 30)
	...
	.byte	0
	.ascii	"\t\t\timmediate = *(p->instr +ip + 1); // This one works instead of the line above." # string offset=1390
	.byte	0
	.ascii	"\t\t\tstack_push(st, ctx->fb + immediate);" # string offset=1471
	.byte	0
	.ascii	"\tst->buf[st->top] = word;"    # string offset=1511
	.byte	0
	.ascii	"\tst->top++;"                  # string offset=1537
	.byte	0
	.ascii	"\t*res = stack_top(st);"       # string offset=1549
	.byte	0
	.ascii	"char"                          # string offset=1572
	.byte	0
	.ascii	"LICENSE"                       # string offset=1577
	.byte	0
	.ascii	"my_pid"                        # string offset=1585
	.byte	0
	.ascii	"collect"                       # string offset=1592
	.byte	0
	.ascii	"frame"                         # string offset=1600
	.byte	0
	.ascii	"loc"                           # string offset=1606
	.byte	0
	.ascii	"frame_spec"                    # string offset=1610
	.byte	0
	.ascii	"cfa_rule"                      # string offset=1621
	.byte	0
	.ascii	"fb_loc_prog"                   # string offset=1630
	.byte	0
	.ascii	"register_rule"                 # string offset=1642
	.byte	0
	.ascii	"rule"                          # string offset=1656
	.byte	0
	.ascii	"reg"                           # string offset=1661
	.byte	0
	.ascii	"offset"                        # string offset=1665
	.byte	0
	.ascii	"req"                           # string offset=1672
	.byte	0
	.ascii	"stack_buf"                     # string offset=1676
	.byte	0
	.ascii	".bss"                          # string offset=1686
	.byte	0
	.ascii	"license"                       # string offset=1691
	.byte	0
